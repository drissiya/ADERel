#######################################################################
# The official script for TAC 2017 Adverse Drug Reaction evaluation
#######################################################################
import argparse
import os
import re
...
from data_utils.tac.drug_label import *
...
if sum(tasks) == 0:
  args.task1, args.task2, args.task3, args.task4 = False, True, False, False
