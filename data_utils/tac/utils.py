...
def get_relations_from_sentence(section_mentions, start, end, relations):
    set_ADE_relation = []
    for m in section_mentions:
        ...
        if m[2] == 'AdverseReaction':
            ...
            for r in relations:
                if m == r[0]:
                    modifier_set_id.add((int(r[2][0].split(',')[0]), (r[2][0], r[2][1], r[2][2], r[2][3], r[2][4], r[1])))
            mention = None           
